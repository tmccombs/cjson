...
{
      15,     0,    -1,    16,    -1,    17,    -1,    20,    -1,     6,
      -1,     5,    -1,     3,    -1,     4,    -1,    13,    -1,     7,
      18,     8,    -1,    19,    -1,    18,    11,    19,    -1,     4,
      12,    16,    -1,     9,    21,    10,    -1,    16,    -1,    21,
      11,    16,    -1
};
...
{
  "$end", "error", "$undefined", "INT", "STRING", "FLOAT", "BOOL",
  "LBRACKET", "RBRACKET", "LARRAY", "RARRAY", "COMMA", "COLON",
  "NULL_TOKEN", "$accept", "top_expr", "expr", "object", "pairs", "pair",
  "array", "expr_list", 0
};
#endif
...
{
      15,     1,     2,     3,     4,     5,    17,     6,    18,    12,
      19,     7,    23,    20,    21,    22,    25,    24
};
...
{
       6,     3,     4,     5,     6,     7,     0,     9,    12,     4,
       8,    13,    18,    11,    10,    11,    22,    20
};
...
{
       0,     3,     4,     5,     6,     7,     9,    13,    15,    16,
      17,    20,     4,    18,    19,    16,    21,     0,    12,     8,
      11,    10,    11,    16,    19,    16
};
...
/* Line 1806 of yacc.c  */
#line 69 "json.y"
    { (yyval.jVal) = json_object((yyvsp[(1) - (1)].oVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 70 "json.y"
    { (yyval.jVal) = json_array((yyvsp[(1) - (1)].aVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 71 "json.y"
    { (yyval.jVal) = json_bool((yyvsp[(1) - (1)].bVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 72 "json.y"
    { (yyval.jVal) = json_float((yyvsp[(1) - (1)].fVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 73 "json.y"
    { (yyval.jVal) = json_int((yyvsp[(1) - (1)].iVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 74 "json.y"
    { (yyval.jVal) = json_string((yyvsp[(1) - (1)].sVal)); }
    break;
...
#line 84 "json.y"
    { 
            json_object_add_pair(&((yyvsp[(1) - (3)].oVal)),(yyvsp[(3) - (3)].oVal)); 
            (yyval.oVal)=(yyvsp[(1) - (3)].oVal);
            }
    break;
...
#line 91 "json.y"
    { 
        (yyval.oVal) = json_make_pair((yyvsp[(1) - (3)].sVal),(yyvsp[(3) - (3)].jVal));
        free((yyvsp[(1) - (3)].sVal));
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 98 "json.y"
    {(yyval.aVal) = llist2array((yyvsp[(2) - (3)].llVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 102 "json.y"
    {(yyval.llVal) = start_llist((yyvsp[(1) - (1)].jVal)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 103 "json.y"
    { (yyval.llVal) = push_llist((yyvsp[(1) - (3)].llVal),(yyvsp[(3) - (3)].jVal)); }
    break;



/* Line 1806 of yacc.c  */
#line 1528 "json.tab.c"
      default: break;
    }
